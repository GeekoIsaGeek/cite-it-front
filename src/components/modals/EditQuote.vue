...
<template>
  <QuoteModalWrapper>
    <div
      class="dialog flex flex-col text-white w-1/2 bg-almostBlack pt-8 overflow-y-scroll pb-7 rounded-xl"
    >
      ...
      <div class="flex flex-col px-6 gap-10">
        ...
        <Form class="flex flex-col gap-6">
          ...
          <FormField
            ...
            v-model="quote_ka"
          />
          <div class="w-full h-[30vw] relative">
            <img
            ...
            >
              <input type="file" class="scale-[1000%] absolute opacity-0" />
              <ThePhotoCameraIcon />
